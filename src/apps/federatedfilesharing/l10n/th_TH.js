OC.L10N.register(
  "federatedfilesharing",
  {
    ...
    "Sharing %s failed, because this item is already shared with %s":
      "การแชร์ %s ล้มเหลวเพราะรายการนี้ถูกแชร์กับ %s",
    "Not allowed to create a federated share with the same user":
      "ไม่อนุญาตให้สร้างแชร์สหพันธ์กับผู้ใช้เดียวกัน",
    ...
    "Sharing %s failed, could not find %s, maybe the server is currently unreachable.":
      "การแชร์ %s ล้มเหลวไม่สามารถหา %s, บางทีอาจจะยังไม่สามารถเข้าถึงเซิร์ฟเวอร์ปัจจุบัน",
    "Federated Sharing failed: %s": "การแชร์ของสหพันธ์ล้มเหลว: %s",
    '"%1$s" shared "%3$s" with you (on behalf of "%2$s")':
      '"%1$s" ได้แชร์ "%3$s" กับคุณ (ในนามของ "%2$s")',
    '"%1$s" shared "%3$s" with you': '"%1$s" ได้แชร์ "%3$s" กับคุณ',
    '"%1$s" invited you to view "%3$s" (on behalf of "%2$s")':
      '"%1$s" ได้เชิญคุณให้ดู "%3$s" (ในนามของ "%2$s")',
    '"%1$s" invited you to view "%3$s"': '"%1$s" ได้เชิญคุณให้ดู "%3$s"',
    Accept: "ยอมรับ",
    Decline: "ลดลง",
    "Share with me through my #ownCloud Federated Cloud ID, see %s":
      "แชร์ผ่าน #ownCloud ด้วยไอดีคลาวด์สหพันธ์ สามารถดูได้ที่ %s",
    "Share with me through my #ownCloud Federated Cloud ID":
      "แชร์ผ่าน #ownCloud ด้วยไอดีคลาวด์สหพันธ์",
    ...
    "Periodically synchronize outdated federated shares for active users":
      "ประสานข้อมูลแชร์ของผู้ใช้ที่ใช้งานอยู่ล้าสมัย",
    "Allow users on this server to send shares to other servers":
      "อนุญาตให้ผู้ใช้บนเซิร์ฟเวอร์นี้สามารถแชร์ไปยังเซิร์ฟเวอร์อื่น ๆ",
    "Allow users on this server to receive shares from other servers":
      "อนุญาตให้ผู้ใช้บนเซิร์ฟเวอร์นี้สามารถรับการแชร์จากเซิร์ฟเวอร์อื่น ๆ",
    "Automatically accept federated shares from trusted servers":
      "ยอมรับการแชร์สหพันธ์โดยอัตโนมัติจากเซิร์ฟเวอร์ที่เชื่อถือได้",
